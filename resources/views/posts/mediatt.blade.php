...
<div class="main-content-wrap page-news col-sm-9">
    @if($hightLight)
    <a href="/chi-tiet-tin-tuc/{{$hightLight->slug}}">
        <div style="display: flex; justify-content: right;">
            ...
            <div style="flex: 0 0 80%;">
                <img style="width: 100%; height: 400px" src="/storage/{{$hightLight->thumbnail}}" alt="">
    ...
    @if($notHightLight)
        ...
        <a href="/chi-tiet-tin-tuc/{{$nh->slug}}">
            <div class="box-video" style=" margin: 0 10px;">
                <img style="width: 100%; height: 400px" src="/storage/{{$nh->thumbnail}}" alt="">
